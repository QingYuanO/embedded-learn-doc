...
<img src={`https://${process.env.NEXT_PUBLIC_IMAGE_HOST}/gpio/gpio1.png`} alt="GPIO基本结构" />


### GPIO位结构

<img src={`https://${process.env.NEXT_PUBLIC_IMAGE_HOST}/gpio/gpio2.png`} alt="GPIO位结构" />
